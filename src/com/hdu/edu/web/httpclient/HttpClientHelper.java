...
public class HttpClientHelper {
  ...
  public Response<String> get(String url, HttpKeyValues header, HttpKeyValues param) {
    ...
    if (header == null) header = new HttpKeyValues();
    if (param == null) param = new HttpKeyValues();

    this.overrideHeader(header);

    try {
      ret =
          session.get(url).headers(header.getKeyValues()).params(param.getKeyValues())
              .allowRedirects(true).text();
    } catch (Exception e) {
      e.printStackTrace();
      ret = null;
    }
  ...
  public Response<String> post(String url, HttpKeyValues header, HttpKeyValues param) {
    ...
    try {
      ...
      RequestBuilder rb =
          session.post(url).headers(header.getKeyValues()).data(param.getKeyValues())
              .allowPostRedirects(true);
  ...
  public Response<String> get(String url, HttpKeyValues header, HttpKeyValues param,
    ...
    try {
      RequestBuilder rb =
          session.get(url).headers(header.getKeyValues()).data(param.getKeyValues());

      if (cookies != null) for (String key : cookies.keySet()) {
  ...
  public RequestBuilder getRb(String url, HttpKeyValues header, HttpKeyValues param,
      Map<String, String> cookies) {
  ...
  public RequestBuilder getPostRb(String url, HttpKeyValues header, HttpKeyValues param,
      Map<String, String> cookies) {
    RequestBuilder ret = null;
